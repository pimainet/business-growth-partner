...
export function BusinessAssessment() {
  ...
  function downloadReport() {
    ...
    const lines = [
      'BGS™ BUSINESS AUDIT — BÁO CÁO CHẨN ĐOÁN',
      `Ngày thực hiện: ${date}`,
      '',
    ...
    a.href = url
    a.download = 'bgs-business-audit-report.txt'
    a.click()
            ...
            <div className="relative mx-auto max-w-2xl">
              ...
              <Reveal delay={80}>
                <h2 className="mt-6 text-balance text-3xl font-semibold leading-tight tracking-tight sm:text-4xl">
                  Doanh nghiệp của bạn đang sẵn sàng tăng trưởng đến đâu?
                </h2>
              </Reveal>
              <Reveal delay={140}>
                <p className="mt-4 text-pretty text-navy-foreground/70">
                  {QUESTIONS.length} câu hỏi, khoảng 2 phút. Kết quả tính từ
