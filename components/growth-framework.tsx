...
> = {
  ...
  'operational-excellence': {
    ...
    result: 'Giảm sai sót thủ công, rút ngắn thời gian xử lý mỗi đơn hàng',
...
const COLUMNS = [
  ...
  { key: 'result', label: 'Kết quả kỳ vọng' },
] as const
...
export function GrowthFramework() {
  return (
    <section
      id="framework"
      className="relative overflow-hidden border-b border-border bg-secondary/40 py-24 lg:py-32"
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <SectionHeading
            ...
            description="Phương pháp chúng tôi dùng để chẩn đoán và thiết kế lại cách doanh nghiệp tăng trưởng — mỗi giai đoạn có Input, Process, Output, KPI, sai lầm thường gặp và công cụ áp dụng rõ ràng."
          />
          <Reveal delay={200}>
              ...
              >
                ...
                <div className="grid grid-cols-[1.4fr_2.6fr] gap-6 border-t border-dashed border-border bg-secondary/30 px-6 py-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <ChipRow label="Ví dụ áp dụng" items={stage.tools} tone="accent" />
                    <ChipRow label="KPI theo dõi" items={stage.kpi} />
                  </div>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal key={stage.title} delay={i * 80}>
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="grid size-11 shrink-0 place-items-center rounded-lg border border-border bg-secondary text-accent">
